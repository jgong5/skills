...
conflict rates on a real gfx942 GEMM), the occupancy and intensity arithmetic
to run before writing a tile, and a table of failure signatures -- spills that
...
skills/
  ...
  implementation-study/  # SKILL.md + five phase docs, experiments.md,
                         ...
                         # tutorial.css
  kernel-perf/           # SKILL.md + ablation.md, modelling.md, bank_model.py
tests/
  asm_tutorial/          # pytest suite for asm-tutorial's scripts
  kernel_perf/           # pytest suite for the bank model
